...
import 'package:flutter_template_name/src/common/util/debouncing.dart';
import 'package:flutter_test/flutter_test.dart';

void main() => group('Debouncing -', () {
  ...
  group('debouncing', () {
    ...
    test('constructor', () {
      expect(() => Debouncing<int>(duration: const Duration(seconds: 1)), returnsNormally);
    });
