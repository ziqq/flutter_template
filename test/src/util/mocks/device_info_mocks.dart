const fakeAndroidBuildVersion = <String, Object?>{
  'sdkInt': 16,
  'baseOS': 'baseOS',
  'previewSdkInt': 30,
  'release': 'release',
...
const fakeDisplayMetrics = <String, Object?>{'widthPx': 1080.0, 'heightPx': 2220.0, 'xDpi': 530.0859, 'yDpi': 529.4639};
...
const fakeAndroidDeviceInfo = <String, Object?>{
  'id': 'id',
  'host': 'host',
  'tags': 'tags',
  'type': 'type',
...
const iosUtsnameMap = <String, Object?>{
  'release': 'release',
  'version': 'version',
  'machine': 'machine',
  'sysname': 'sysname',
...
const iosDeviceInfoMap = <String, Object?>{
  'name': 'name',
  'model': 'model',
