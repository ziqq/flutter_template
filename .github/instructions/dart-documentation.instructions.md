---
applyTo: "**/*.dart"
description: "Use when: generating or editing Dart and Flutter code, especially documentation comments for widgets, controllers, repositories, models, screens, and public APIs."
---

# Dart Documentation Instructions

Follow these rules when generating or editing Dart and Flutter code comments.

Use this instruction when code needs documentation comments that teach another developer how to use the API. Write docs that explain purpose, constraints, and correct usage without forcing the reader into the implementation.
